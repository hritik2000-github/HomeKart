...
<div class="small-container">
        <h2 class="title">Women's Wardrobe</h2>
        <div class="row">

        <div class="col-4">
        <form action="manage_cart.php" method="POST">
                <img src="images/w1.jpg" alt="Couldn't load image" height="300">
                <h4>Printed Khadi Dupatta</h4>
                <div class="rating">
                ...
                <input type="hidden" name="Item_Name" value="Printed Khadi Dupatta">
