    ...
    <div class="small-container">
        ...
        <div class="col-4">
            <form action="manage_cart.php" method="POST">
                ...
                <input type="hidden" name="Item_Name" value="HRX Shoe">
...
?>
            ...
            <div class="col-4">           
                    <form action="manage_cart.php" method="POST">
                    <img src="watch/louis-mornaud-ADvixEYm5qE-unsplash.jpg">
                    <h4>PREMIUM WATCH</h4>
                    <div class="rating">
                        <i class="fa fa-star"></i>
                        <i class="fa fa-star"></i>
                    ...
                    <p>Rs.49999</p>
                    <button type="submit"  name="Add_To_Cart" class="btn btn-info">Add To Cart</button>
                <input type="hidden" name="Item_Name" value="Premium watch">
                <input type="hidden" name="Price" value="49999">
                    </form>
                </div>
...
?>
            ...
            <div class="col-4">
                <form action="manage_cart.php" method="POST">
                    <img src="purse/james-ree-ZmeFtu11Hpc-unsplash.jpg">
                    <h4>GUCCI PURSE</h4>
                    <div class="rating">
                        <i class="fa fa-star"></i>
                        <i class="fa fa-star"></i>
                    ...
                    <button type="submit"  name="Add_To_Cart" class="btn btn-info">Add To Cart</button>
                <input type="hidden" name="Item_Name" value="Gucci Purse">
                <input type="hidden" name="Price" value="49999">
                </form>
                </div>
...
?>
            ...
            <div class="col-4"> 
                    ...
                    <p>Rs.49999</p>
                    <button type="submit"  name="Add_To_Cart" class="btn btn-info">Add To Cart</button>
                <input type="hidden" name="Item_Name" value="Diamond Jewellery">
                <input type="hidden" name="Price" value="49999">
                </form>
                </div>
...
if($resultCheck > 0){
     ...
     while ($row = mysqli_fetch_array($img)) {  
        if($row['ptype']==$check){   
      	echo "<img src='Jewellery/".$row['image']."' >"; 
          echo "$row[name]"; 
         echo "<br>";
         echo "<div class='rating'>
         <i class='fa fa-star'></i>
