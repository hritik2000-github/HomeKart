...
<body>
    ...
    <div class="row">
        <div class="col">
        <h1>Hom<span class="first">eK</span><span class="second">art<span></h1>
        ...
        <div class="col">
            ...
            <div class="card card2">
                <h3><a href="edible.php"> Edible</a></h3>
                
            </div>
            <div class="card card3">
                <h3><a href="accessories.php"> Acessories</a></h3>
                
            </div>
            <div class="card card4">
                <h3><a href="furniture.php"> Others</a></h3>
